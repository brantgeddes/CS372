...
CREATE TABLE Transactions (id INT AUTO_INCREMENT NOT NULL UNIQUE, stock_id INT NOT NULL, user_id INT NOT NULL, quantity INT NOT NULL, value INT, timestamp DATETIME NOT NULL, type VARCHAR(10) NOT NULL, PRIMARY KEY(id), FOREIGN KEY(stock_id) REFERENCES Stocks(id), FOREIGN KEY(user_id) REFERENCES Users(id));
